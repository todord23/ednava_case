...
###Creating a directory Temp, if not exists, then file with 10 random sites.
$x= "C:\Temp\"
if(!$x){
...
{
(Get-ChildItem -Filter "0.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-1.txt"

 (Get-ChildItem -Filter "1.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-2.txt"

   (Get-ChildItem -Filter "2.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-3.txt"

    (Get-ChildItem -Filter "3.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-4.txt"

	 (Get-ChildItem -Filter "4.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-5.txt"

	  (Get-ChildItem -Filter "5.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-6.txt"

	   (Get-ChildItem -Filter "6.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-7.txt"

	    (Get-ChildItem -Filter "7.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-8.txt"

		 (Get-ChildItem -Filter "8.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-9.txt"

		  (Get-ChildItem -Filter "9.txt" -Recurse | Select-String -pattern "href=" -AllMatches) | Out-File -Append -LiteralPath "C:\Temp\hrefOutput\href1-10.txt"
}
